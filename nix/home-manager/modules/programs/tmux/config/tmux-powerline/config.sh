...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/brooklyn/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/brooklyn/.mailcheckrc"
# }
