  ...
  home-manager.users.${config.common.username} = {
    targets.darwin.defaults = {
      "eu.exelban.Stats" = {
        ...
        "NSStatusItem Preferred Position CPU" = 559;
        "NSStatusItem Preferred Position Disk" = 390;
        "NSStatusItem Preferred Position GPU_line_chart" = 503;
        "NSStatusItem Preferred Position Network_speed" = 619;
        "NSStatusItem Preferred Position RAM_pie_chart" = 461;
